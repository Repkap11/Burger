...
public class BurgerServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("/WEB-INF/Burger-42de36b9e316.json"))
                .setDatabaseUrl("https://burger-1af72.firebaseio.com/")
                .build();
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("reminder@burger-1af72.appspotmail.com",
                            "Todo Reminder"));
